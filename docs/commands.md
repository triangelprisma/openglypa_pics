...
<div align="center">
  ...
  В "Типы контента" можно выбрать можно какие команды бота можно использовать в чате, а в "Автоматический вызов" - какой контент он будет реагировать самостоятельно </br> </br> 
</div>
